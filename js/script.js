...
const typed = new Typed(".multiple-text", {
    strings: ['Backend Developer.','Graphic Designer.','GoLang Developer.','Freelancer.'],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
...
$("#submit-form").submit((e)=>{
    ...
    $.ajax({
        url:"https://script.google.com/macros/s/AKfycbyJNUWc3p0KEQjVOkCSzApz3SuRPjb_2PAmVGACJmDdfWL_PSjlSKdaX7s3SxjDWe6DuA/exec",
